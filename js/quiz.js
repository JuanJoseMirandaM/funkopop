function prg01(value,i){
    ...
    if (value == 1) {
        ...
        document.getElementById('btn01_0'+i).setAttribute("class", "btn btn-danger btn-lg btn-block")   
    } 
...
function prg02(value,i){
    ...
    if (value == 1) {
        ...
        document.getElementById('btn02_0'+i).setAttribute("class", "btn btn-danger btn-lg btn-block")   
    } 
    document.getElementById('btn02_01').setAttribute("class", "btn btn-success btn-lg btn-block")   
...
function prg03(value,i){
    ...
    if (value == 1) {
        ...
        document.getElementById('btn03_0'+i).setAttribute("class", "btn btn-danger btn-lg btn-block")   
    } 
    document.getElementById('btn03_03').setAttribute("class", "btn btn-success btn-lg btn-block")   
...
function prg04(value,i){
    ...
    if (value == 1) {
        ...
        document.getElementById('btn04_0'+i).setAttribute("class", "btn btn-danger btn-lg btn-block")   
    } 
